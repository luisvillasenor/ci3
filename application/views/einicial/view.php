    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="panel panel-default">
              <div class="panel-body">
                                ...
                                Edad: <?php echo $edad;?>
                                Sexo: <?php echo $sexo;?>
                                Días de abstinencia: <?php echo $dias_abs;?>
                                Droga: <?php echo $droga;?>
                                Tiempo consumiendo: <?php echo $t_consumo;?>
                                Droga inicial: <?php echo $droga_ini;?>
                                Edad primer consumo: <?php echo $edad1con;?>
                                Edo. Civil: <?php echo $edo_civ;?>
                                No. de hijos: <?php echo $hijos;?>
                                Escolaridad: <?php echo $escolaridad;?>
                                Trabajo: <?php echo $trabajo;?>
                                Creciste en: <?php echo $creciste_en;?>
              </div>
            </div>
          <div>
        ...
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Autoestima PRE</a></li>
        </ul>
        <!-- Tab panes -->
        <div class="tab-content">
          <div role="tabpanel" class="tab-pane active" id="home">
            ...
            <ul class="nav nav-tabs" role="tablist">
              ...
              <?php } ?>
              <li role="presentation"><a href="#resultados" aria-controls="resultados" role="tab" data-toggle="tab">Resultados/Diagnóstico <br>  <?php echo $fecha_aplicacion;?></a></li>
            </ul>
